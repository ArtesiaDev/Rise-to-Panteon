...
{
    public static class UIRuntimeUtils
    {
        ...
        public static Button CreateButton(Transform parent, string name, string label, int fontSize, Color background, Color textColor)
        {
